...
| **-NO** | Asks the user to try again for a number of rolls less than 100 (try 99 and 10)                           |
| **-NO** | Outputs the list of values generated                                                                     |
...
- You don't need to use global in this project. 
- Some of this code can be wrapped in a function. We've talked about input validation in the class and in other labs you could have used that to accept number of roles from the users. 
- 
